let add_button = document.querySelector(
  ...
  function run_algorithm(e) {
    ...
    anychart.onDocumentReady(function () {
      ...
      // set the chart title
      chart.title("process CT comparison");
  ...
  function tableCreate() {
    ...
    for (let i = 0; i < rowLength - 1; i++) {
      ...
      document.getElementById("cc" + i).style.cc = "50px";
      ...
      document.getElementById(x.id).style.margin = "5px";
      document.getElementById(y.id).style.margin = "5px";
